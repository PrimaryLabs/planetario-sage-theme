...
class CategoryArchive extends Composer
{
    ...
    public function with(): array
    {
        ...
        $termId   = ($term instanceof \WP_Term) ? $term->term_id : 0;
        ...
        return [
            'categoryName'        => ($term instanceof \WP_Term) ? $term->name : 'Posts',
            'categoryDescription' => ($term instanceof \WP_Term) ? $term->description : '',
            'categoryCount'       => ($term instanceof \WP_Term) ? (int) $term->count : 0,
            'archivePosts'        => $posts,
            'archivePagination'   => $pagination ?: [],
            'archiveHasMore'      => $query->max_num_pages > 1,
    ...
    private function normalize(WP_Post $post): array
    {
        ...
        return [
            ...
            'bodyPreview'   => \wp_trim_words(strip_tags($post->post_content), 30, '…'),
