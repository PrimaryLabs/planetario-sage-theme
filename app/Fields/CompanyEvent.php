        ...
        acf_add_local_field_group([
            ...
            'fields'   => [
                ...
                [
                    ...
                    'instructions'    => 'Add images, video files or YouTube links in any order. Same media model as a Success Story; use the caption for context.',
                    'rf_sub_fields'   => implode("\n", [
                        'media_type | Media type | select | image:Image,video:Video upload,youtube:YouTube link',
                        'media_url | Media / image URL | url',
