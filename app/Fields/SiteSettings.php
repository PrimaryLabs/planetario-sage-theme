...
class SiteSettings
{
    ...
    private static function brandFields(): array
    {
        return [
            [
                'key'           => 'field_ss_brand_logo',
                'label'         => 'Logo',
                'name'          => 'brand_logo',
                'type'          => 'image',
                'return_format' => 'id',
                'preview_size'  => 'medium',
                'instructions'  => 'Primary site logo. Used in the header. Saved to WordPress as the Custom Logo.',
                'wrapper'       => ['width' => '33'],
            ],
            [
                'key'           => 'field_ss_brand_logo_dark',
                'label'         => 'Logo (dark variant)',
                'name'          => 'brand_logo_dark',
                'type'          => 'image',
                'return_format' => 'id',
                'preview_size'  => 'medium',
                'instructions'  => 'Optional. Shown over dark backgrounds (e.g. footer).',
                'wrapper'       => ['width' => '33'],
            ],
            [
                'key'           => 'field_ss_brand_site_icon',
                'label'         => 'Site Icon (Favicon)',
                'name'          => 'brand_site_icon',
                'type'          => 'image',
                'return_format' => 'id',
                'preview_size'  => 'thumbnail',
                'instructions'  => 'Square image, at least 512×512px. Used as browser favicon and app touch icon.',
                'wrapper'       => ['width' => '34'],
            ],
            [
                'key'           => 'field_ss_brand_og_image',
                'label'         => 'Default social share image',
                'name'          => 'brand_og_image',
                'type'          => 'image',
                'return_format' => 'id',
                'preview_size'  => 'medium',
                'instructions'  => 'Recommended 1200×630px. Used for Open Graph / Twitter previews when a page has no featured image.',
            ],
            [
                'key'           => 'field_ss_brand_site_title',
                'label'         => 'Site title',
                'name'          => 'brand_site_title',
                'type'          => 'text',
                'instructions'  => 'WordPress site title. Shown in browser tabs and search results. Synced to Settings → General.',
                'default_value' => 'Planetario Realty',
                'wrapper'       => ['width' => '50'],
            ],
            [
                'key'           => 'field_ss_brand_site_tagline',
                'label'         => 'Site tagline',
                'name'          => 'brand_site_tagline',
                'type'          => 'text',
                'instructions'  => 'WordPress tagline. Synced to Settings → General.',
            ...
            [
                ...
                'name'          => 'brand_name',
                'type'          => 'text',
                'instructions'  => 'Display name used across the site copy (header, footer, etc.). Can match the site title.',
                'default_value' => 'Planetario Realty',
            ],
            [
            ...
            [
                ...
                'name'          => 'brand_tagline',
                'type'          => 'text',
                'instructions'  => 'Rendered in the footer and brand sections. Separate from the WordPress tagline above.',
                'default_value' => 'Turning Property Dreams into Reality',
            ],
            [
