    ...
    <div class="specs">
      ...
      <span>
        <svg width="14" height="14" viewBox="0 0 16 16" fill="none" aria-hidden="true">
          <path d="M2 12V5m12 7V8a2 2 0 0 0-2-2H6m-4 6h12m-12 0v1m12-1v1" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" />
          <circle cx="5" cy="8" r="1.2" stroke="currentColor" stroke-width="1.2" />
        </svg>
        {{ $p['beds'] }} bd
      </span>
      @endif
      ...
      <span>
        <svg width="14" height="14" viewBox="0 0 16 16" fill="none" aria-hidden="true">
          <path d="M2 9h12M3 9v3a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V9M5 9V5a1.5 1.5 0 0 1 3 0v.5" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" />
        </svg>
        {{ $p['baths'] }} ba
      </span>
      @endif
      ...
      <span>
        <svg width="14" height="14" viewBox="0 0 16 16" fill="none" aria-hidden="true">
          ...
          <path d="M2.5 6.5h11M6.5 2.5v11" stroke="currentColor" stroke-width="1.2" opacity=".5" />
        </svg>
        {{ $p['area'] }} sqm
      </span>
      @elseif (!empty($p['lot']))
