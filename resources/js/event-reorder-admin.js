(function () {
    ...
    var config  = window.eventReorderAdmin || {};
    var dragging = null;

    function initDragDrop() {
        document.querySelectorAll('.event-reorder-item').forEach(bindItem);
    }
    ...
    function collectOrder() {
        ...
        document.querySelectorAll('.event-reorder-list .event-reorder-item').forEach(function (item) {
            order.push({
    ...
    function showNotice(type, msg) {
        var el = document.getElementById('event-reorder-notice');
        if (!el) return;
    ...
    function saveOrder() {
        ...
        .then(function (data) {
            setLoading(false);
            if (data.success) {
                showNotice('success', 'Order saved — ' + data.updated + ' events updated.');
            } else {
